...
describe('controller', function () {
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo1 = {id: 91,title: 'todo 1', completed: false};
			var todo2 = {id: 92, title: 'todo 2', completed: false};
			...
			expect(model.update).toHaveBeenCalledWith(91, {completed: true}, jasmine.any(Function));
			expect(model.update).toHaveBeenCalledWith(92, {completed: true}, jasmine.any(Function));
		});
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			...
			view.trigger('newTodo', 'Nouvelle tâche');

			expect(model.create).toHaveBeenCalledWith('Nouvelle tâche', jasmine.any(Function));
		});
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			// TODO: write test
			var todo = {id: 90, title: 'tâche à supprimer'};
			setUpModel([todo]);

			subject.setView('');

			view.trigger('itemRemove', {id: 90});

			expect(model.remove).toHaveBeenCalledWith(90, jasmine.any(Function));
		});
